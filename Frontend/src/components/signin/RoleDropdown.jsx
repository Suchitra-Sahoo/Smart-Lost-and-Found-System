    ...
    <div className="relative">
      ...
      <button
        ...
        className="w-full pl-10 md:pl-12 pr-4 py-2.5 md:py-3 rounded-xl border border-gray-600
          ...
          text-sm md:text-base bg-zinc-800 hover:bg-zinc-700 flex items-center"
      >
      ...
      {open && (
        <ul className="absolute z-10 w-full text-gray-100 pt-1 bg-zinc-800 rounded-xl shadow-md border border-gray-600 mt-1">
