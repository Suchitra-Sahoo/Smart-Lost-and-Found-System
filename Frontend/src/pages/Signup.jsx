...
//       <div className="hidden md:flex h-screen pt-6">
//         <SignupLeft images={images} currentImage={currentImage} />
//       </div>

//       {/* Right side (Form) */}
//       <div className="w-full flex items-center justify-center bg-gradient-to-br from-orange-100 via-orange-200 to-orange-300 relative">
